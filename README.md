...
* vanilla-1.4.4.8, vanilla-latest, latest [(containers/vanilla/1.4.4.8/Dockerfile)](https://github.com/beardedio/terraria/blob/master/containers/vanilla/1.4.4.8/Dockerfile)
