...
* vanilla-1.4.1.0, vanilla-latest, latest [(containers/vanilla/1.4.1.0/Dockerfile)](https://github.com/beardedio/terraria/blob/master/containers/vanilla/1.4.1.0/Dockerfile)
