...
* vanilla-1.4.4.5, vanilla-latest, latest [(containers/vanilla/1.4.4.5/Dockerfile)](https://github.com/beardedio/terraria/blob/master/containers/vanilla/1.4.4.5/Dockerfile)
