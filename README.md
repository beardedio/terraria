...
* vanilla-1.4.4.4, vanilla-latest, latest [(containers/vanilla/1.4.4.4/Dockerfile)](https://github.com/beardedio/terraria/blob/master/containers/vanilla/1.4.4.4/Dockerfile)
