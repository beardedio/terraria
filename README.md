...
* vanilla-1.4.2, vanilla-latest, latest [(containers/vanilla/1.4.2/Dockerfile)](https://github.com/beardedio/terraria/blob/master/containers/vanilla/1.4.2/Dockerfile)
