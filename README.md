...
* vanilla-1.4.5.2, vanilla-latest, latest [(containers/vanilla/1.4.5.2/Dockerfile)](https://github.com/beardedio/terraria/blob/main/containers/vanilla/1.4.5.2/Dockerfile)
